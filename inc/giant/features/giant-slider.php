<?php
function giant_slider_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	/*=========================================
	Slider Section Panel
	=========================================*/
	$wp_customize->add_panel(
		'giant_frontpage_sections', array(
			'priority' => 32,
	 ...
	 */
		...
		$wp_customize->add_setting( 'slider', 
			array(
			 ...
			 'priority' => 8,
			 'default' => giant_get_slider_default()
			)
		);
		...
		//Pro feature
		class Giant_slider__section_upgrade extends WP_Customize_Control {
			public function render_content() { 
				$theme = wp_get_theme(); // gets the current theme	
				
			?>
				<a class="customizer_slider_upgrade_section up-to-pro" href="https://www.nayrathemes.com/giant-pro/" target="_blank" style="display: none;"><?php esc_html_e('Upgrade to Pro','clever-fox'); ?></a>
		...
		$wp_customize->add_control(
			new Giant_slider__section_upgrade(
			$wp_customize,
...
add_action( 'customize_register', 'giant_slider_setting' );


// slider selective refresh
function giant_home_slider_section_partials( $wp_customize ){	
	// slider title
...
add_action( 'customize_register', 'giant_home_slider_section_partials' );