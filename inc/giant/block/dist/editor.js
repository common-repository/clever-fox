 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "giantInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .giantInfos .giantInfo .title{\n                        ")
                                .concat(O, " .giantInfos .giantInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "giantIconTitle ".concat(n) },
        ...
        Ra = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "giantInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #giantInfo-"
                                    .concat(x, " .giantInfo .bgLayer{\n                    ")
                                    .concat(x, " .giantInfo .title{\n                    color: ")
                                    .concat(x, " .giantInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #giantInfo-")
                                    .concat(x, " .giantInfo .description{\n                    color: ")
                                    .concat(x, " .giantInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "giantInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".giantInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".giantInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
